...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, FaultShapeComponent],
  schemas: [CUSTOM_ELEMENTS_SCHEMA],
  template: `
    <div class="controls">
      <button (click)="addFault('rectangle', 1)">Add Rectangle (Cat 1)</button>
      <button (click)="addFault('circle', 1)">Add Circle (Cat 1)</button>
      <button (click)="addFault('rectangle', 2)">Add Rectangle (Cat 2)</button>
      <button (click)="addFault('circle', 2)">Add Circle (Cat 2)</button>
      <button (click)="addFault('rectangle', 3)">Add Rectangle (Cat 3)</button>
      <button (click)="addFault('circle', 3)">Add Circle (Cat 3)</button>
      <button (click)="clearFaults()">Clear All</button>
    </div>
